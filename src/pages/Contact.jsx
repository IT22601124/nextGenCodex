          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-[#001F3F] font-medium mb-2">
                    Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-[#001F3F] font-medium mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-[#001F3F] text-white rounded-lg font-semibold hover:bg-[#001F3F]/90 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="bg-white border border-[#001F3F] p-8 rounded-xl">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-[#001F3F] rounded-lg flex items-center justify-center hover:bg-[#001F3F]/90 transition-all duration-300">
